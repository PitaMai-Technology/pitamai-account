...
<template>
  ...
  <div>
    <main>
      ...
      <p class="description">
        Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://pitamai-technology.sentry.io/issues/?project=4510496093503488">Issues Page</a>.
